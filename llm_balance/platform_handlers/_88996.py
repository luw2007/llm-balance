...
class Handler88996(BasePlatformHandler):
    ...
    def _load_env_config(self):
        ...
        env_user_id = os.getenv('CLOUD88996_API_USER_ID')
        if env_user_id:
        ...
        config_path = Path.home() / '.llm_balance' / '88996_config.yaml'
    ...
    def get_balance(self) -> CostInfo:
        ...
        cookie_domain = getattr(self.config, 'cookie_domain', '88996.cloud')
