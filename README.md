...
Check coding plan limits for Claude Code compatible platforms (Volcengine, Zhipu, Codex):
...
> - **Codex**: Read local `~/.codex/sessions/**/rollout-*.jsonl` logs generated by Codex CLI sessions
